...
import { Cpu, Lock, ShieldCheck, ShieldAlert, Key } from "lucide-react";
...
export default function ResetPasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess("Your key credentials have been updated. Redirecting to login...");
      setTimeout(() => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 relative">
      ...
      <div className="w-full max-w-md glass-card rounded-3xl p-8 relative overflow-hidden shadow-2xl border border-indigo-500/20">
        ...
        {/* Glow */}
        <div className="absolute -top-16 -right-16 w-36 h-36 rounded-full bg-purple-500/10 blur-3xl"></div>
        ...
        <div className="flex flex-col items-center mb-6">
          ...
          <p className="text-xs text-slate-400 mt-1">Configure a new override key</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          >
            {loading ? "Overriding credentials..." : "Override Credentials"}
          </button>
        </form>
